...
//
//    public DataInitializer(TheaterRepository theaterRepository, SeatRepository seatRepository, ShowingRepository showingRepository, ReservationSeatRepository reservationSeatRepository, ReservationRepository reservationRepository, MovieRepository movieRepository, UserRepository userRepository, PasswordEncoder passwordEncoder) {
...
//
//                User user1 = userRepository.save(new User(null, "Alice", LocalDate.of(1990, 5, 15), Role.CUSTOMER, passwordEncoder.encode("123")));
//                User user2 = userRepository.save(new User(null, "Mikkel", LocalDate.of(1999, 10, 13), Role.EMPLOYEE, passwordEncoder.encode("123")));
//                User user3 = userRepository.save(new User(null, "Sara", LocalDate.of(1921, 1, 1), Role.ADMIN, passwordEncoder.encode("123")));
//
