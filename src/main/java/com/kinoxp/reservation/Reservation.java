...
public class Reservation {
    ...
    public Reservation(Long reservationId, Showing showing, User user, LocalDateTime createdAt,
                       double totalPrice, BookingStatus bookingStatus, PaymentStatus paymentStatus) {
    ...
    public List<ReservationSeat> getReservedSeats() { return reservedSeats; }
