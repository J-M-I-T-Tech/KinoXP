...
import com.kinoxp.movie.AgeLimit;
...
class ReservationServiceTest {
    ...
    void createReservation_ifRole_isEmploye() {
        ...
        when(reservationSeatRepository.existsByReservation_Showing_ShowingIdAndSeat_SeatId(1L, 4L)).thenReturn(false);
